...
static  GHashTable *parse_func_table;

void
pjx_markup_add_parse_func (char *element_name, TagParseFunc parse_func)
{
  g_hash_table_insert (parse_func_table, element_name, parse_func);
}

void
pjx_markup_init ()
{
  parse_func_table = g_hash_table_new (g_str_hash, g_str_equal);

  pjx_markup_add_parse_func("b", b_parse_func);
  pjx_markup_add_parse_func("big", big_parse_func);
  pjx_markup_add_parse_func("i", i_parse_func);
  pjx_markup_add_parse_func("markup", markup_parse_func);
  pjx_markup_add_parse_func("span", span_parse_func);
  pjx_markup_add_parse_func("s", s_parse_func);
  pjx_markup_add_parse_func("sub", sub_parse_func);
  pjx_markup_add_parse_func("sup", sup_parse_func);
  pjx_markup_add_parse_func("small", small_parse_func);
  pjx_markup_add_parse_func("tt", tt_parse_func);
  pjx_markup_add_parse_func("u", u_parse_func);
  pjx_markup_add_parse_func("s", s_parse_func);
}
...
pjx_markup_destroy ()
{
  g_hash_table_destroy (parse_func_table);
}
                        ...
                        GError             **error)
{
  ...
  parse_func = g_hash_table_lookup (parse_func_table, element_name);
 ...
 **/
gboolean
pjx_parse_markup (const char                 *markup_text,
                    int                         length,
      ...
      while (tmp_list != NULL)
        {
          ...
          pjx_attr_list_change (md->attr_list, attr);
...
/* FIXME : instant hack */
void
pjx_markup_add_attribute_to_context(OpenTag *ot,
               PangoAttribute *attr)
{
  add_attribute (ot, attr);
}
